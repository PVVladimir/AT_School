public class Homework001 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Площадь квадрата с стороной " + squareSide + " равна " + squareArea(squareSide));
        double circleRadius = 7.3;
        System.out.println("Площадь круга с радиусом " + circleRadius + " равна " + circleArea(circleRadius));
